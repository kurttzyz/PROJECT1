    ...
    <div class="row">
        <div class="col-md-3 col-lg-2 col-xl-2 p-3 bg-white">
            <a href="#" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
                ...
                <span class="image">
                <div class="logo-container frame-container">
                    <div class="frame">
                        <?php ; ?> 
                    </div>
                </div>                
            ...
            <form action="index.php" method="POST" enctype="multipart/form-data" id="update-profile-form">
            ...
            <span class="user_fullname">
              <div class="information">
                 ...
                 <br>
                Grade & Section : <?php echo $strand; ?>
              </div>
            </span>
            <hr>
            <ul class="list-unstyled ps-0" style="text-align: center; margin-top:10px">
                <li class="mb-1">
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse" id="account-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="update.php" class="link-dark rounded">Update Profile</a></li>
